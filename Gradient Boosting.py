...
gb_clf = GradientBoostingClassifier(n_estimators = 300,learning_rate = 0.1, max_depth = 5)
...
CVS = cross_val_score(gb_clf,X_train,y_train, cv = 5, scoring = "accuracy")
CVS = np.mean(CVS)
print(CVS)
...
Grid_search= GridSearchCV( estimator = gb_clf, param_grid = parameters,scoring = 'accuracy', cv = 5,verbose = 2)

...
CVS = cross_val_score(xgb_clf,X_train,y_train, cv = 5, scoring = "accuracy")
CVS = np.mean(CVS)
print(CVS)
...
Grid_search= GridSearchCV( estimator = xgb_clf, param_grid = parameters,scoring = 'accuracy', cv = 5,verbose = 2)
